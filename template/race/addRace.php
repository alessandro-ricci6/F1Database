    ...
    <div class="driverForm mx-4 mt-3 col-5 text-center">
        ...
        <div class="py-1">
            ...
            <select class="form-select border-dark addRaceSelect" name="trackSelect" id="trackSelect">
                <?php foreach ($tracks as $track): ?>
                    <option value="<?php echo $track['idTrackVersion']; ?>">
                        <?php echo $track['trackName'] . ' - ' . $track['trackLength'] . 'm'; ?>
                    </option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="py-1 d-flex">
            ...
            <div class="form-check mx-5">
                <input class="form-check-input" type="radio" name="flexRadioDefault" id="normalRadio" value="Normal"
                    checked>
        ...
        <button class="btn btn-dark mt-2 w-50" onclick="addRace()"><i class="fa-solid fa-arrow-right"></i></button>
    </div>
